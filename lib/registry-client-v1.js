...
function pingIndex(opts, cb) {
    ...
    assert.optionalString(opts.ca, 'opts.ca');
 ...
 * @param opts.ca {String} Optional. Default null. Set to a PEM encoded
 *      certificate chain to override the default CA certificates.
 * ...
 *
 */
